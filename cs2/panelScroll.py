...
class GUI(wx.Frame):
    ...
    def __init__(self,parent,id,title):
        ...
        screenHeight = screenSize[1]/3

        #Create a frame
        wx.Frame.__init__(self,parent,id,title,size=wx.Size(screenWidth,screenHeight), style=wx.DEFAULT_FRAME_STYLE ) # ^ wx.RESIZE_BORDER

        panel1 = wx.Panel(self,size=(screenWidth,28), pos=(0,0), style=wx.SIMPLE_BORDER)
        panel1.SetBackgroundColour('#FDDF99')
        panel2 = wx.lib.scrolledpanel.ScrolledPanel(self,-1, size=(screenWidth-40,200), pos=(0,28), style=wx.SIMPLE_BORDER)
