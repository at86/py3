...
class MainFrame(wx.Frame):
    def __init__(self):
        ...
        #                          "sample1.html"))
        self.cefWindow = chrome.ChromeWindow(self, os.getcwd() + "/sample1.html")
        self.cefWindow2 = chrome.ChromeWindow(self, os.getcwd() + "/sample1.html")
        sizer = wx.BoxSizer()
        sizer.Add(self.cefWindow, 1, wx.EXPAND, 0)
        sizer.Add(self.cefWindow2, 1, wx.EXPAND, 0)
        self.SetSizer(sizer)
...
if __name__ == '__main__':
    chrome.Initialize({
        "debug": True,
        "cache_path": "D:/linuxShare/watsen/python/cefpython/build.exe.win32-2.7/webcache/",
        "log_file": "D:/linuxShare/watsen/python/cefpython/build.exe.win32-2.7/webcache/debug.log",
